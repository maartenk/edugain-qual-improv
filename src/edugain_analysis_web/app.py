"""FastAPI web interface for eduGAIN analysis."""
...
def cli():
    """Console entrypoint for launching the web interface."""
    parser = argparse.ArgumentParser(
        description="Run the eduGAIN analysis web interface."
    )
