...
Usage:
    python -m edugain_analysis_web.import_data
    python -m edugain_analysis_web.import_data --validate-urls
    python -m edugain_analysis_web.import_data --test-data --days 30
"""

import sys
from datetime import datetime, timedelta

from edugain_analysis.core.analysis import analyze_privacy_security
...
from edugain_analysis_web.models import (
    Entity,
    Federation,
    SessionLocal,
    Snapshot,
