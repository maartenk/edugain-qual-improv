...
from edugain_analysis.web.import_data import (
    generate_test_data,
    import_snapshot,
)
...
class TestImportSnapshot:
    ...
    @patch("edugain_analysis.web.import_data.SessionLocal")
    @patch("edugain_analysis.web.import_data.parse_metadata")
    @patch("edugain_analysis.web.import_data.get_metadata")
    @patch("edugain_analysis.web.import_data.get_federation_mapping")
    @patch("edugain_analysis.web.import_data.analyze_privacy_security")
